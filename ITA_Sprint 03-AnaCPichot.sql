...
/* =================================================================================================NIVELL 1 ===============================================================================================================================
Exercici 1.- La teva tasca és dissenyar i crear una taula anomenada "credit_card" que emmagatzemi detalls crucials sobre les targetes de crèdit. La nova taula ha de ser capaç d'identificar de manera única cada targeta i establir una relació adequada amb les altres dues taules ("transaction" i "company"). 
...
FROM transactions.credit_card cc;
...
-- ==========================================================================
-- crear la taula USERS e insertar les dades a la taula a partir de l'arxiu que ens han proporcionat.
...
INSERT INTO company -- Step 1.- make sure the company existis company id is a foreign key.
	(id	,company_name,phone,email,country,website) VALUES ('b-9999','name_unknown','phone_unknown','email_unknown','country_unknown','website_unknown');
    
INSERT INTO credit_card (id,iban,pin,cvv,expiring_date) VALUES ('CcU-9999',99999,null,null,null);

INSERT INTO transaction -- Insert data. Timestamp unknown so we insert it as default value, null.
	(id	,credit_card_id,company_id,	user_id,lat,longitude,timestamp,amount,declined) VALUES ('108B1D1D-5B23-A76C-55EF-C568E49A99DD','CcU-9999','b-9999',9999,829.999,-117.999,NULL,111.11,0);
...
-- Modificacions realitzades en la taula user   
-- Canviar el nom de la taula
ALTER TABLE transactions.user RENAME TO transactions.data_user;

-- 1.- Modificar el datatype de les columnes.
ALTER TABLE transactions.data_user
    MODIFY id CHAR(10);
    
-- renombra columna EMAIL
ALTER TABLE transactions.data_user
    RENAME COLUMN email TO personal_email;

-- 2.- Modificacions realitzades en la taula company
-- esborrar columna Website
ALTER TABLE company
DROP COLUMN website;

-- 3.- Modificacions realitzades en la taula transaction

ALTER TABLE transaction
MODIFY credit_card_id VARCHAR(10) 
...
-- CREAR claus foraneas en la taula transaction . 
ALTER TABLE transaction
...
FOREIGN KEY (user_id) 
REFERENCES transactions.data_user(id);

-- 4.- Modificacions realitzades en la taula credit_card
USE transactions;
SELECT CURDATE();
